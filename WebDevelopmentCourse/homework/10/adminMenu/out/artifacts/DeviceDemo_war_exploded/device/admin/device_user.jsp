...
<script>
    ...
    function getMenuRecord() {
        ...
        $.post("../../" + "device" + "_" + "file" + "_servlet_action?action=get_device_record", function (res) {
            console.log(res);
            showMenuRecord(res);
        });
        ...
        function showMenuRecord(res) {
                ...
                if (list != undefined && list.length > 0) {
                    for (var i = 0; i < list.length; i++) {
                        ...
                        var itemUrl = record.item_url; // assuming this is still used
                        console.log("设备ID:" + deviceId + "---设备名称：" + deviceName);
                        ...
                        if (currentDeviceId !== deviceId) {
                            ...
                            html = html + "  <span class=\"title\">" + deviceId + "</span>";
