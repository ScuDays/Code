Page({
  ...
  getTodoRecord:function(){
    let that = this;
    wx.request({
      url: 'http://localhost:9988/TeachDemo_war_exploded/project_todo_servlet_action?action=get_todo_record',
  ...
  wx.showModal({
    ...
    success: function(res){
      if(res.confirm){
        ...
        let that = this;
        wx.request({
          url: 'http://localhost:9988/TeachDemo_war_exploded/project_todo_servlet_action?action=delete_todo_record',
          data:{"id":id},
          header:{"content-type":"application/x-www-form-urlencoded","x-requested-with":"XMLHttpRequest"},
          success:function(res){
            //that.handleGetTodoRecordResult(res);
...
onModifyRecord:function(e){
  ...
  let that=this;
  var id = e.currentTarget.dataset.itemid;
  var device_id=e.currentTarget.dataset.itemdevice_id;
  var device_name = e.currentTarget.dataset.itemdevice_name;
  var create_time = e.currentTarget.dataset.itemcreate_time;
