...
Page({
  ...
  onSendTap(e){
    ...
    var sqlInsertRealtime="insert into gps_realtime(device_id,gps_time,recv_time,longitude,latitude,altitude,location,direction,speed,energy,data_source,coordinate_type,creator,creator_id,create_time)";
    ...
    var sqlInsertHistory="insert into gps_history(device_id,gps_time,recv_time,longitude,latitude,altitude,location,direction,speed,energy,data_source,coordinate_type,creator,creator_id,create_time)";
    ...
    wx.request({
      ...
      success:function(res){
        var data={"action":"update_record","sql":sqlInsertRealtime,"db_name":"webyykf2024"};
        that.insertRealtime(url,data);
        var data={"action":"update_record","sql":sqlInsertHistory,"db_name":"webyykf2024"};
